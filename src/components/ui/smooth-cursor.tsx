...
export function SmoothCursor({
  ...
  useEffect(() => {
    // fine-pointer devices only — a synthetic cursor that hides the native
    // one is meaningless (and actively harmful) on touch, where there's no
    // persistent pointer to replace
